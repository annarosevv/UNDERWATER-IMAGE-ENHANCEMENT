...
"""# Channel and Spatial Attention (vector geospatial data in Python)""" 
...
class ChannelGate(nn.Module):##Flattens a contiguous range of dims into a tensor 
...
class CBAM(nn.Module):##ayer in every convolutional block of a convolutional neural network model
